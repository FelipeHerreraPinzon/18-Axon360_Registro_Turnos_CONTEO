...
<html lang="en">
  <head>
    ...
    <title>PERSONAS DE CONTEO</title>
  </head>
  <body class="bg-info">
  <nav class="navbar navbar-expand navbar-light bg-light">
      <div class="nav navbar-nav">
          <a class="nav-item nav-link active" href="#"> <img src="../images/axon_logo.png" alt="" width="30"> AXON 360<span class="visually-hidden">(current)</span></a>
    ...
    <h1 class="text-center"><i class="fas fa-users"></i> PERSONAS DE PROYECTO SDS</h1>
